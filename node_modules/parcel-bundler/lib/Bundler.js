...
class Bundler extends EventEmitter {
  constructor(main, options = {}) {
    ...
    const loadersPath = `./builtins/loaders/${options.target === 'node' ? 'node' : 'browser'}/`;
  ...
  bundle() {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        try {
          for (var _iterator2 = changedAssets[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
